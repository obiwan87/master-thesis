...
S = {'LocalLexicalKnnSubstitution', {'LVi', 'info.LVi', 'vocSizeBefore', 'info.vocSizeBefore', 'vocSizeAfter', 'info.vocSizeAfter'}};
scheme = ReportScheme(S{:});
p = sequence(...
        fork(nop(), pgrid('LocalLexicalKnnSubstitution', 'K', 5:5:30, 'MaxIter', 10)), WordCountMatrix(), ... 
        fork(SVMClassifier('SVMParams', {'Holdout', 0.7}, 'Repeat', 20),  ...
             SVMClassifier('SVMParams', {'Holdout', 0.8}, 'Repeat', 20),  ...
             SVMClassifier('SVMParams', {'Holdout', 0.9}, 'Repeat', 20)));
